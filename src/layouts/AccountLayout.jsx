                ...
                <div className="sidebar md:w-1/4 w-full flex md:flex-col bg-white flex-row items-center pt-8 border-r border-gray-200 mb-4">
                    {
                        side_option.map(option => (
                            <span onClick={() => history.push(option.location)} key={option.id} className={`${location.pathname === option.location ? "md:border-r-4 border-l-0 md:border-b-0 border-b-4 bg-blue-50 border-blue-900 " : "border-none "} p-4 w-full hover:bg-blue-50 cursor-pointer flex flex-row items-center`}>
